...
///
/// The class relies on cognito Authentication for authenticating requests, using a cognito token to perform
...
class LanguageService {
  /// cognitoAuth instance used to interact with cognito Authentication services.
  final cognitoAuth auth;

  /// Constructor that initializes the [LanguageService] with the required [cognitoAuth] instance.
  ///
  /// - [auth]: The cognitoAuth instance used to authenticate requests.
  ...
  /// - [tokenId]: The cognito Authentication token used for authenticating the request.
