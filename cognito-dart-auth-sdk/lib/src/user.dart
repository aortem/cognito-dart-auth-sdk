import 'dart:convert';
import 'package:cognito_dart_auth_sdk/src/provider_user_info.dart';
import 'id_token_result_model.dart';

/// Represents a user object that contains all the necessary information
/// related to a user in cognito Authentication.
///
...
class User {
  ...
  ///
  /// This is useful for parsing JSON responses from cognito or other services.
