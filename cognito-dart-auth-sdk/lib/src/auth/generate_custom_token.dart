...
import 'package:cognito_dart_auth_sdk/src/utils.dart';

/// Implementation for generating custom JWTs for cognito Authentication.
///
...
class GenerateCustomTokenImplementation extends GenerateCustomToken {
  ...
  Future<String> generateServiceAccountJwt(
    ...
    final String scope =
        'https://www.googleapis.com/auth/cognito.database https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/identitytoolkit';
  ...
  /// Generates a sign-in JWT for a cognito user.
  ///
  /// Parameters:
  /// - [serviceAccount]: The [ServiceAccount] for cognito operations.
  /// - [uid]: (Optional) User ID to be embedded in the token.
  /// - [additionalClaims]: (Optional) Additional claims to be included in the JWT.
  ///
  /// Returns a [Future] that resolves to the JWT for signing in a cognito user.
  ///
