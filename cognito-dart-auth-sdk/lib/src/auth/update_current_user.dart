...
/// A service to update the details of the current user in cognito Authentication.
///
/// This service allows you to update the user profile, including fields such as email, display name,
/// photo URL, etc., by sending a request to cognito Authentication's `update` endpoint.
...
class UpdateCurrentUser {
  ...
  /// Updates the current user's profile data in cognito Authentication.
  ///
  /// This method allows updating a user's profile information in cognito Authentication. You can
  /// pass optional user data fields (e.g., email, display name, etc.) in the [userData] parameter.
  ///
  /// Parameters:
  /// - [userId]: The cognito user ID (UID) of the user whose data you want to update.
  /// - [idToken]: The cognito ID token of the user (to verify the user's identity).
  ...
  ///
  /// Throws:
  /// - [cognitoAuthException] if the update fails, providing a code and message to describe the error.
  Future<void> updateCurrentUser(String userId, String idToken,
    ...
    try {
      ...
      // The cognito Authentication endpoint to update user details
      final url = 'update';

      // Perform the request to update the user in cognito Authentication
      ...
      // Throw a cognitoAuthException if the update operation fails
      throw cognitoAuthException(
