...
/// A service that manages the persistence setting for cognito users.
///
...
class PersistenceService {
  /// The [cognitoAuth] instance used to interact with cognito Authentication.
  ///
  /// This instance is required to interact with cognito Authentication APIs
  ...
  ///
  /// Parameters:
  /// - [auth]: The [cognitoAuth] instance used for authentication actions.
  ...
  ///
  /// Throws:
  /// - [cognitoAuthException] if the request to update the persistence field in Firestore fails.
