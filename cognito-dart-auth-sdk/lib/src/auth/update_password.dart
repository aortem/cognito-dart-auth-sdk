...
/// Service to update the user's password in cognito Authentication.
class UpdatePassword {
  ...
  /// Updates the password for a cognito user.
  ///
  /// This method takes the user's [newPassword] and [idToken] (obtained during sign-in)
  /// and makes a request to cognito to update the password.
  ///
  /// Parameters:
  ...
  ///
  /// Throws:
  /// - [cognitoAuthException] if the request to update the password fails.
  Future<User> updatePassword(
    ...
    try {
      ...
      // Perform the request to cognito to update the user's password.
