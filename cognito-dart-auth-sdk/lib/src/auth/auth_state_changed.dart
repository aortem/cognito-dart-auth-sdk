...
/// Service to monitor and manage cognito authentication state changes.
///
/// This service listens to the cognito authentication state and
...
class OnAuthStateChangedService {
  /// The [cognitoAuth] instance used to listen for authentication state changes.
  ...
  ///
  /// Parameters:
  /// - [auth]: The [cognitoAuth] instance that triggers the auth state events.
  ///
  ...
  OnAuthStateChangedService(this._auth) {
    // Listen to the simplified stream from cognitoAuth
